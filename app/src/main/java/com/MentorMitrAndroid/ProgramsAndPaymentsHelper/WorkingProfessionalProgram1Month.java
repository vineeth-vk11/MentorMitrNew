...
public class WorkingProfessionalProgram1Month extends AppCompatActivity implements PaymentResultListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_working_professional_program1_month);
        ...
        Button workingpayment1 = findViewById(R.id.pay_working_1month);
        workingpayment1.setOnClickListener(v -> {
            startPayment();
        });
    ...
    public void startPayment() {
        ...
        try {
             ...
             *     etc.
             */
            options.put("description", "Working Professional 1 Month Program");
