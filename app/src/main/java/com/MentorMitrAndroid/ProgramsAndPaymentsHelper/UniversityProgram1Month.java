...
public class UniversityProgram1Month extends AppCompatActivity implements PaymentResultListener {

    Button universityPayment1;
    String date;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_university_program1_month);

        Date c = Calendar.getInstance().getTime();
        SimpleDateFormat simpleDateFormat = new SimpleDateFormat("dd-MM-yyyy");
        date = simpleDateFormat.format(c);

        universityPayment1 = findViewById(R.id.pay_university_1month);
        universityPayment1.setOnClickListener(v -> {
            startPayment();
        });
    ...
    public void startPayment() {
        ...
        try {
             ...
             *     etc.
             */
            options.put("description", "University 1 Month Program");
