...
public class StudentProgram1Year extends AppCompatActivity implements PaymentResultListener {

    String date;
    Button schoolPayment12;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_student_program1_year);
        ...
        schoolPayment12 = findViewById(R.id.pay_student_12month);
        schoolPayment12.setOnClickListener(v -> {
            startPayment();
        });
    ...
    public void startPayment() {
        ...
        try {
             ...
             *     etc.
             */
            options.put("description", "Student 1 Year Program");
