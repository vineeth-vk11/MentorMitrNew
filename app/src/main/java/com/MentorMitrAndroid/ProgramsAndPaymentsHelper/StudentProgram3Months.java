...
public class StudentProgram3Months extends AppCompatActivity implements PaymentResultListener {

    String date;
    Button schoolPayment3;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_student_program3_months);
        ...
        schoolPayment3 = findViewById(R.id.pay_student_3month);
        schoolPayment3.setOnClickListener(v -> {
            startPayment();
        });
    }
    ...
    public void startPayment() {
        ...
        try {
             ...
             *     etc.
             */
            options.put("description", "Student 3 Month Program");
